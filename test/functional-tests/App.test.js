...
describe('App', () => {
  ...
  describe('DELETE', () => {
    it('should handle DELETE', () => {
      const deleteEndPoint = '/deletesomething'
      ...
      return client.delete(LOCALHOST + deleteEndPoint)
        .then(response => {
          expect(response.status).to.eq(200)
        })
    })
    it('should handle DELETE returns response', () => {
      const deleteEndPoint = '/deletesomething'
      ...
      return client.delete(LOCALHOST + deleteEndPoint)
        .then(response => {
          ...
          expect(response.data).to.eq('some value')
        })
    })
  })
